...
int RelCacheTable::getRelCatEntry(int relId, RelCatEntry *relCatBuf)
{
    ...
    // printf("relcache:%s", relCache[relId]->relCatEntry.relName);
...
//! IMP The caller should allocate memory for the struct RelCatEntry and array of union Attribute before calling the function.
